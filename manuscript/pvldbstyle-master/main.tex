...
% ===== 新增中文支持代码 =====
% ===== 轻量化中文支持，免费Overleaf不超时 =====
\usepackage{fontspec}

% \setmainfont{Times New Roman}
% \setsansfont{Arial}
% ubuntu本地没有Times New Roman和Arial字体，所以暂时用Tinos 和Arimo来代替

\setmainfont{Tinos}
\setsansfont{Arimo}

% 内置中文字体，局部调用
\newfontfamily{\cn}{Noto Sans CJK SC}[Scale=MatchLowercase]

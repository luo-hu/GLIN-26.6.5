...
def main():
    ...
    paths.extend(plot_mixed_metric(rows, output_dir, args.figure_prefix, "representative_point_shortcuts", "Representative-point shortcuts per interval", "representative_point_shortcuts", args.dpi, skip_zero_series=True, rolling_window=rolling_window))
    ...
    paths.extend(plot_mixed_metric(rows, output_dir, args.figure_prefix, "geos_exact_ms", "GEOS exact CPU time per interval (ms)", "geos_exact_ms", args.dpi, skip_zero_series=True, rolling_window=rolling_window))
    paths.extend(plot_mixed_metric(rows, output_dir, args.figure_prefix, "avg_geos_exact_ns", "Average GEOS exact call time (ns)", "avg_geos_exact_ns", args.dpi, skip_zero_series=True, rolling_window=rolling_window))
    paths.extend(plot_mixed_metric(rows, output_dir, args.figure_prefix, "geos_exact_query_fraction", "GEOS exact share of query time", "geos_exact_query_fraction", args.dpi, skip_zero_series=True, rolling_window=rolling_window))
